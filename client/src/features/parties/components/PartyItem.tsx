...
import ModeAddRoom from './modeAddRoom';

function PartyItem():JSX.Element {
 ...
 const closeModelHandler = () => {
  ...
  return (
    <div>
     <button onClick={openModelHandler} type='button'>add room</button>
     {openModel && <ModeAddRoom onClose={closeModelHandler} />}
    </div>
  )
}
